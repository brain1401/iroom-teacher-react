// src/components/examsheet/ProblemListTab.tsx
...
import type { Problem, ExamSheet } from "@/types/exam-sheet";
 ...
 * ```tsx
 * // 기본 사용법
 * function ExamSheetCreationFlow() {
 ...
 *       onPreviewExamSheet={() => openPreviewModal()}
 *       onBack={() => navigate(-1)}
 ...
 *
 * // 커스텀 문제지 생성 워크플로우
 * function CustomExamCreationWorkflow() {
 *   const [currentStep, setCurrentStep] = useState(1);
 *   const [examConfig, setExamConfig] = useState(initialConfig);
 *
 *   return (
 ...
 *           problems={examConfig.generatedProblems}
 *           onReorderProblems={(problems) =>
 *             setExamConfig(prev => ({ ...prev, problems }))
 *           }
 *           // ... 기타 props
 *         />
 *       )}
...
type ProblemListTabProps = {
   ...
   *   previewWindow.postMessage({ problems, examName }, '*');
   * };
   * ```
   */
  onPreviewExamSheet: () => void;
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <h1 className="text-2xl font-bold">{examName} 문제 목록</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={onPreviewExamSheet}>
