 ...
 *
 * 데이터 구조:
 * - selectedSubmission: 학생의 기본 제출 정보 (TestSubmitStatusDetail 타입)
 ...
 *   
 *   const handleOpenAnswerSheet = (submission: TestSubmitStatusDetail) => {
 ...
 *   return (
 *     <>
 *       <TestDetailTable onOpenDetail={handleOpenAnswerSheet} />
 *       <AnswerSheetResult
 ...
 *
 * // API 연동 예시
 * const handleOpenAnswerSheet = async (submission: TestSubmitStatusDetail) => {
 *   setSelectedSubmission(submission);
 *   
 *   try {
 ...
 *
 * 데이터 요구사항:
 * - TestSubmitStatusDetail: student, testName, submissionDate, totalScore 포함
